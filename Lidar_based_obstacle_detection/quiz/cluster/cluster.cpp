...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
    ...
    while(i < points.size())
    {
      ...
      clusterhelper(i,points, cluster, processed,tree, distanceTol); //proximity function
...
// commented because of the error conflicting declaration of C function 'int main
/*int main ()
{
